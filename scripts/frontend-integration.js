 ...
 * This file demonstrates how to integrate Speecht5 with a web frontend
 */

// For React/Vue/Angular applications
export class Speecht5Client {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new Speecht5Client(provider, contractAddress);
